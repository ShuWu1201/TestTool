 ...
 **/
public class Demo_07_01_thread_createdepartment {
    ...
    static final Demo_07_01_thread_createdepartment demo_07_01_thread_createdepartment = new Demo_07_01_thread_createdepartment();
    ...
    @RepeatedTest(100)
    @Execution(ExecutionMode.CONCURRENT)
    void testCreateDepartmentParal(){
        demo_07_01_thread_createdepartment.createDepartment("name123456", "en_name1234567", "0");
    }
