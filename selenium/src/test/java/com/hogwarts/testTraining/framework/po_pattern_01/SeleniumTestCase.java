...
/**
 * @ClassName SeleniumTestCase，用于web
...
public class SeleniumTestCase {
     ...
     * @return
     */
    public List<SeleniumTestCase> testcaseGenerate(){
        List<SeleniumTestCase> seleniumTestCaseList = new ArrayList<>();
        for (int i = 0; i < data.size(); i++) {
            SeleniumTestCase seleniumTestCaseNew = new SeleniumTestCase();
            seleniumTestCaseNew.index = i;
            seleniumTestCaseNew.steps = steps;
            seleniumTestCaseNew.data = data;
            seleniumTestCaseList.add(seleniumTestCaseNew);
        }
        return seleniumTestCaseList;
    }
