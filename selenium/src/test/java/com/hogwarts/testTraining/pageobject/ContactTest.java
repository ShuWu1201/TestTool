package com.hogwarts.testTraining.pageobject;
...
//        Set<Cookie> cookies = (Set<Cookie>) mapper.readValue(new File("cookies.yaml"), typeReference);
    ...
    @Test
    void departmentAdd() throws InterruptedException {
        click(By.id("menu_contacts"));
        sendKeys(By.id("memberSearchInput"), "测试部门一");
        String content = webDriver.findElement(By.cssSelector(".js_party_info")).getText();
        ...
        content = webDriver.findElement(By.cssSelector(".js_party_info")).getText();
        System.out.println("------------------" + content);
     ...
     */
    @Test
    public void testAddContactSimplePackage01() throws InterruptedException {

        click(By.id("menu_index"));
        ...
        sendKeys(By.name("mobile"), "15013145200");


        //webDriver.findElement(By.linkText("保存并继续添加")).click();
        click(By.linkText("保存并继续添加"));
